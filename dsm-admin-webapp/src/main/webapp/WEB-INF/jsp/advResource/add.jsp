...
<link rel="stylesheet" href="${basepath }/res/css/bootstrap-datetimepicker.css">
                  ...
                  <form action="javascript:void(0);" method="post" class="form-horizontal">
                   ...
                   <div class="control-group">
                    ...
                    <div class="control-group media">
                      ...
                      <div class="controls">
                        <input id="con" name="content" class="span11" data-valid="[{rule:'not_empty'}]" placeholder="必填,图片视频上传后自动获得" readonly="readonly">
                      </div>
                    </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input id="url" name="url" type="text" class="span11" placeholder="选填，长度不大于255" data-valid="[{rule:'url'}]" maxlength="255">
                      </div>
                    </div>
                    ...
                    <div class="control-group" style="width:500px;">
                      ...
                      <div class="controls">
                        <input id="startUtc" name="startUtcStr" type="datetime" class="span11 form_datetime" placeholder="必填" data-valid="[{rule:'not_empty'}]" maxlength="20">
                      </div>
                    </div>
                    ...
                    <div class="control-group" style="width:500px;">
                      ...
                      <div class="controls">
                        <input id="endUtc" name="endUtcStr" type="datetime" class="span11 form_datetime" placeholder="必填" data-valid="[{rule:'not_empty'}]" maxlength="20">
                      </div>
                    </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <textarea rows="5" name="remark" class="span11" placeholder="选填，长度不大于255"></textarea>
                      </div>
                    </div>
...
function initUpload () {
	$("#picload").zyUpload({
		...
		url              :   "${basepath}/public/terminalUpload",   	 // 上传文件的路径
