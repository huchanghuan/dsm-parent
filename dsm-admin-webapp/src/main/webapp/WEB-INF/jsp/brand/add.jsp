	...
	<div class="container-fluid">
		<div class="row-fluid">
            ...
            <ul class="nav nav-tabs">
                  <li role="presentation"><a href="${basepath }/brand/toList">品牌列表</a></li>
                  <li role="presentation" class="active"><a href="${basepath }/brand/toAdd">新建品牌</a></li>
                </ul>
                ...
                <div class="widget-content nopadding">
                  <form action="javascript:void(null);" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input id="name" type="text" name="name" class="span11" data-valid="[{rule:'not_empty'}]" placeholder="必填，长度不大于30" maxlength="30">
                      </div>
                    </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input id="initial" type="text" name="initial" class="span11" data-valid="[{rule:'not_empty'},{rule:'upper_letter'}]" placeholder="必填，长度为1的大写字母" maxlength="1">
                      </div>
                    </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input id="pinyin" type="text" name="pinyin" class="span11" data-valid="[{rule:'not_empty'},{rule:'lower_letter'}]" placeholder="必填,不大于100" maxlength="100">
                      </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="form-actions">
                    	...
                    	<div class="control">
                      <button type="button" class="btn btn-success" disabled="disabled">保存</button>
                   	</div>
                    </div>
                  </form>
                </div>
