                  ...
                  <form action="javascript:void(0);" method="post" class="form-horizontal">
                   ...
                   <input type="hidden" name="status" value="1">
                    ...
                    <div class="control-group media">
                      ...
                      <div class="controls">
                        <input id="con" name="image1" class="span11" data-valid="[{rule:'not_empty'}]" placeholder="必填,图片视频上传后自动获得" readonly="readonly">
                      </div>
                    </div>
                    ...
                    <div class="control-group" style="width:500px;">
                      ...
                      <div class="controls">
                        <input id="name" name="title" type="datetime" class="span11" placeholder="必填,不大于20" data-valid="[{rule:'not_empty'}]" maxlength="20">
                      </div>
                    </div>
                     ...
                     <div class="control-group">
                      ...
                      <div class="controls">
                        <textarea rows="5" class="span11" name="slogan" placeholder="选填，长度不大于128"></textarea>
                      </div>
                    </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <textarea rows="5" class="span11" name="description" placeholder="选填，长度不大于255"></textarea>
                      </div>
                    </div>
