                ...
                <div class="widget-content nopadding">
                  <form id="addForm" action="javascript:void(0);" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input id="username" name="username" class="span7" placeholder="必填，长度不大于20" data-valid="[{rule:'not_empty'}]" maxlength="20">
                      </div>
                    </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input id="password" name="password" type="password" class="span7" placeholder="必填，长度不大于20" data-valid="[{rule:'not_empty'}]" maxlength="20">
                      </div>
                    </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls" >
                        <input id="phone" name="phoneNo" class="span7" placeholder="选填，长度不大于16" data-valid="[{rule:'mobile'}]" maxlength="16">
                      </div>
                    </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input id="email" name="email" type="email" class="span7" placeholder="选填，长度不大于50" data-valid="[{rule:'email'}]" maxlength="50">
                      </div>
                    </div>
