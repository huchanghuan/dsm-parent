        	...
        	<div class="span12">
              ...
              <div class="widget-box cool-list-box">
                  ...
                  <div class="widget-title" style="height:50px">
                    ...
                    <button id="batchPay" class="btn btn-danger pull-right btn-large" disabled="disabled">批量付款</button>
...
$(function(){
	...
	$("td .btn-danger").livequery(function(){
		$(this).click(function(){
            ...
            console.log(data);
            $.batchPay(data.id, data.sellerId, data.dealPrice);
		});
	});
});
...
function initTable() {
	...
	$table = $('#tableBox').bootstrapTable({
        ...
        columns: [{
        	...
        	title : '状态',
        	formatter : function(data, row, index) {
        		var html = '<span class="label label-success">已签收</span>';
            ...
            formatter: function(data, row ,index){
				...
				html += '<button class="btn btn-danger btn-mini">付款</a>';            
                html += '</div>';
                return html;
            }
        }],
